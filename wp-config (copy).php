...
define('DB_NAME', 'hestia3_moco');

/** MySQL database username */
define('DB_USER', 'hestia3_mocous');

/** MySQL database password */
define('DB_PASSWORD', 'rveXl5o1E3OLV80C');
/** MySQL hostname */
define('DB_HOST', 'webstylze-db-3.churotv0qfgf.us-west-1.rds.amazonaws.com');
