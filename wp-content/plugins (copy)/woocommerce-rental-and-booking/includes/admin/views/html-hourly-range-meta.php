...
<div class="hourly_range_group redq-remove-rows sort ui-state-default" style="background: none; border: none;">
    ...
    <div class="redq-show-bar">
        <h4 class="redq-headings"> <?php _e('Hours','redq-rental'); ?> ( <?php echo esc_attr($min_hours); ?> - <?php echo esc_attr($max_hours); ?> ) <?php _e('-  Cost','redq-rental'); ?> : <?php echo esc_attr($range_cost); ?><?php echo esc_attr(get_woocommerce_currency_symbol()); ?>
