<div class="date-time-picker rnb-component-wrapper rc_datetime">
	...
	<?php if(isset($displays['pickup_date']) && $displays['pickup_date'] !== 'closed'): ?>
		<h5><?php //echo esc_attr($labels['pickup_datetime']); ?>Delivery Date</h5>
		<span class="pick-up-date-picker">
			<i class="fa fa-calendar"></i>
			<input type="text" name="pickup_date" id="pickup-date" placeholder="<?php //echo esc_attr($labels['pickup_date']); ?>Delivery Date" value="" readonly>
		</span>
	<?php endif; ?>
