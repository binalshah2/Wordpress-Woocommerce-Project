<div class="date-time-picker rnb-component-wrapper rc_datetime">
	<?php
	...
	<?php if(isset($displays['return_date']) && $displays['return_date'] !== 'closed'): ?>
		<h5><?php //echo esc_attr($labels['return_datetime']); ?>Collection Date</h5>
		<span class="drop-off-date-picker">
			<i class="fa fa-calendar"></i>
			<input type="text" name="dropoff_date" id="dropoff-date" placeholder="<?php //echo esc_attr($labels['return_date']); ?>Collection Date" value="" readonly>
		</span>
	<?php endif; ?>
