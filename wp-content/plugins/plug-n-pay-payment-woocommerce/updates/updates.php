...
class WC_PlugnPay_License_Updates {

	const SECRET_KEY = '5b34ae90764af4.57283112';
	const SERVER_URL = 'https://pledgedplugins.com';
	const LONG_NAME = 'WooCommerce Plug\'n Pay Gateway (Pro)';
	const SHORT_NAME = 'WooCommerce Plug\'n Pay';
	const VAR_IDS = '6994,6995,6996,15226,30903,30905,30907,30909';
	const PLUGIN_SLUG = 'plug-n-pay-payment-woocommerce';
	...
	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new WC_PlugnPay_License_Updates();
		}
...
WC_PlugnPay_License_Updates::get_instance();