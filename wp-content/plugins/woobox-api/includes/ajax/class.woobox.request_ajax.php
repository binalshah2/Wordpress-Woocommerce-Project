...
function woobox_token_request_ajax_final()
{
    ...
    /*print_r(get_site_url().'/oauth1/access?oauth_verifier='.$_REQUEST['oauth_verifier']."\n\n");
    print_r('OAuth oauth_consumer_key="'.$consumer_key
     .'",oauth_token="'.$oauth_token.'",oauth_signature_method="'.$oauth_signature_method
