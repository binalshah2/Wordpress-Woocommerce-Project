		        ...
		        foreach($orders as $o) {
					...
					foreach( $order->get_items() as $item ) {
                        ...
                        foreach ($order_item_details as $order_item_key => $order_item_value ) {
                            ...
                            if( $order_item_value->key !== 'pickup_hidden_datetime' && $order_item_value->key !== 'return_hidden_datetime' && $order_item_value->key !== 'return_hidden_days' && $order_item_value->key !== 'booking_inventory' ){
