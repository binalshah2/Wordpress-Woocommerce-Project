...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) {
	...
	function storefront_primary_navigation_wrapper() {
		echo '<div class="rc_currency_txt">All prices quoted are in Barbados Dollars.</div>
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper_close' ) ) {
	...
	function storefront_primary_navigation_wrapper_close() {
		echo '</div><div class="rc_crane_logo"><a href="https://www.crane.bb/" target="_blank"><img width="230" height="110" src="https://moco.bb/wp-content/uploads/2020/04/crane-logo.png" class="custom-logo" alt="Moco"></a></div>';
	}
}
